//
//  roommateMessageUserListViewController.swift
//  weet
//
...
class roommateMessageUserListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider {
    
    var itemInfo: IndicatorInfo = "ルームメイト"
    var myTableView1: UITableView!
    let matching = "roommate_favo_users"
