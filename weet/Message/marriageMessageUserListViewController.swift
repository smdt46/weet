//
//  marriageMessageUserListViewController.swift
//  weet
//
...
class marriageMessageUserListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider {
