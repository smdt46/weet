//
//  goodLoveListViewController.swift
//  weet
//
...
class goodLoveListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider {
